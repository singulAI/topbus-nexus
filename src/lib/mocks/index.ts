...
export const sectorsMock: Sector[] = [
  {
    id: "portaria",
    name: "Portaria",
    description: "Controle de entrada e saída de veículos e registros de avaria.",
    moduleCount: 4,
    recentRecords: 12,
    status: "operacional",
  },
  {
    id: "manutencao",
    name: "Manutenção",
    description: "Gestão de avarias, ordens de serviço e oficinas.",
    moduleCount: 7,
    recentRecords: 23,
    status: "atencao",
  },
  {
    id: "frota",
    name: "Frota",
    description: "Acompanhamento da disponibilidade e status dos veículos.",
    moduleCount: 5,
    recentRecords: 18,
    status: "operacional",
  },
  {
    id: "operacao",
    name: "Operação",
    description: "Escala operacional, linhas e rotas urbanas.",
    moduleCount: 6,
    recentRecords: 41,
    status: "operacional",
  },
  {
    id: "rh",
    name: "RH",
    description: "Cadastro de colaboradores, documentos e escalas.",
    moduleCount: 3,
    recentRecords: 9,
    status: "operacional",
  },
  {
    id: "financeiro",
    name: "Financeiro",
    description: "Custos, relatórios e conferência de serviços terceirizados.",
    moduleCount: 5,
    recentRecords: 15,
    status: "atencao",
  },
  {
    id: "abastecimento",
    name: "Abastecimento",
    description: "Registro de litragem, postos e cupons.",
    moduleCount: 2,
    recentRecords: 7,
    status: "operacional",
  },
  {
    id: "terceirizados",
    name: "Terceirizados",
    description: "Prestadores externos e serviços contratados.",
    moduleCount: 3,
    recentRecords: 11,
    status: "operacional",
  },
  {
    id: "gestao",
    name: "Gestão",
    description: "Visão executiva consolidada de todos os setores.",
    moduleCount: 9,
    recentRecords: 62,
    status: "operacional",
  },
...
export const vehiclesMock: Vehicle[] = [
  {
    ...
    type: "Ônibus urbano",
    status: "manutencao",
    note: "Vidro do letreiro quebrado",
  },
  { id: "v2", number: "21052", type: "Ônibus urbano", status: "ativo" },
  {
    ...
    type: "Ônibus urbano",
    status: "parado",
    note: "Aguardando manutenção elétrica",
  },
  {
    id: "v4",
    number: "33108",
    ...
    note: "Aguardando bomba injetora",
  },
...
export const driversMock: Driver[] = [
  {
    ...
    status: "ativo",
    lastSchedule: "30/04/2026 07:20",
    vehicleNumber: "97021",
  },
  {
    id: "d2",
    name: "MOTORISTA TESTE 01",
    chapa: "9001001",
    role: "MOTORISTA URBANO",
    status: "ativo",
    lastSchedule: "29/04/2026 14:00",
  },
  {
    id: "d3",
    name: "ANTONIO CARLOS SILVA",
    chapa: "9712001",
    role: "MOTORISTA URBANO",
    status: "ativo",
    lastSchedule: "30/04/2026 05:10",
    vehicleNumber: "21052",
  },
  {
    id: "d4",
    name: "JOSE RIBEIRO LIMA",
    chapa: "9714502",
    role: "MOTORISTA URBANO",
    status: "afastado",
  },
...
export const providersMock: Provider[] = [
  {
    ...
    status: "ativo",
    servicesCount: 14,
    accumulatedValue: 28450,
  },
  {
    id: "p2",
    name: "AUTO ELÉTRICA SANTOS",
    serviceType: "Elétrica",
    status: "ativo",
    servicesCount: 8,
    accumulatedValue: 12300,
  },
  {
    id: "p3",
    name: "FUNILARIA CENTRAL",
    serviceType: "Funilaria",
    status: "ativo",
    servicesCount: 5,
    accumulatedValue: 9700,
  },
  {
    id: "p4",
    name: "BORRACHARIA UNIÃO",
    serviceType: "Pneus",
    status: "inativo",
    servicesCount: 22,
    accumulatedValue: 18900,
  },
];
...
export const routesMock: Route[] = [
  {
    ...
    name: "Centro / Bairro",
    status: "ativa",
    vehicles: ["97021", "44215"],
  },
  {
    id: "r2",
    line: "2550",
    name: "Terminal / Industrial",
    status: "ativa",
    vehicles: ["21052", "82091"],
  },
...
export const serviceRecordsMock: ServiceRecord[] = [
  {
    ...
    description: "Substituição completa após falha no engate",
    value: 4800,
    authorizer: "Supervisor Manutenção",
    status: "registrado",
  ...
  },
  {
    id: "sv2",
    vehicleNumber: "74226",
    providerName: "AUTO ELÉTRICA SANTOS",
    executor: "Carlos Santos",
    serviceType: "Elétrica",
    serviceDone: "REVISÃO DO CHICOTE ELÉTRICO",
    value: 1200,
    authorizer: "Gestor Frota",
    status: "em_andamento",
  ...
  },
  {
    id: "sv3",
    vehicleNumber: "55672",
    providerName: "FUNILARIA CENTRAL",
    executor: "Equipe Funilaria",
    serviceType: "Funilaria",
    serviceDone: "REPARO LATERAL DIREITA",
    value: 2350,
    authorizer: "Supervisor Manutenção",
    status: "aguardando",
...
export const fleetStatusMock: FleetStatus[] = [
  {
    ...
    stoppedAt: "28/04/2026",
    expectedRelease: "02/05/2026",
    priority: "media",
  },
  {
    vehicleNumber: "74226",
    status: "parado",
    reason: "Aguardando manutenção elétrica",
    responsibleSector: "Manutenção",
    stoppedAt: "27/04/2026",
    expectedRelease: "03/05/2026",
    priority: "alta",
  },
  {
    vehicleNumber: "33108",
    status: "aguardando_peca",
    reason: "Bomba injetora",
    responsibleSector: "Manutenção",
    stoppedAt: "25/04/2026",
    expectedRelease: "05/05/2026",
    priority: "alta",
  },
  {
    vehicleNumber: "55672",
    status: "aguardando_terceiro",
    reason: "Funilaria externa",
    responsibleSector: "Terceirizados",
    stoppedAt: "25/04/2026",
    expectedRelease: "01/05/2026",
    priority: "media",
  },
  {
    vehicleNumber: "90017",
    status: "inativo",
    reason: "Baixa programada",
    responsibleSector: "Gestão",
    stoppedAt: "10/03/2026",
    expectedRelease: "-",
    priority: "baixa",
  },
];
...
export const insightsMock: Insight[] = [
  {
    id: "i1",
    title: "Veículo 97021 com ocorrência recente",
    description: "Avaria no letreiro registrada há 3 dias. Recomenda-se inspeção complementar.",
    severity: "alerta",
    category: "Frota",
  },
  {
    id: "i2",
    title: "Veículos aguardando peça há mais de 5 dias",
    description: "2 veículos estão parados aguardando reposição. Verificar fornecedor.",
    severity: "critico",
    category: "Manutenção",
  },
  {
    id: "i3",
    title: "Registros sem fotos obrigatórias",
    description: "4 registros pendentes de anexo de imagem antes/depois.",
    severity: "alerta",
    category: "Operação",
  },
  {
    id: "i4",
    title: "Custo de avarias concentrado em veículos parados",
    description: "70% do custo do mês vem de 3 veículos. Avaliar plano de recuperação.",
    severity: "info",
    category: "Financeiro",
  },
  {
    id: "i5",
    title: "Mecânica concentra maior custo do período",
    description: "Serviços de mecânica representam 58% do total terceirizado no mês.",
    severity: "info",
    category: "Financeiro",
  },
  {
    id: "i6",
    title: "Escala reduz preenchimento manual por chapa",
    description: "Adoção da busca por chapa elimina 80% do retrabalho operacional.",
    severity: "info",
    category: "Operação",
  },
];
...
export const uploadedDocumentsMock: UploadedDocument[] = [
  {
    ...
    fileName: "orcamento-eder-21052.pdf",
    uploadedAt: "29/04/2026",
    uploadedBy: "Supervisor Manutenção",
  },
  {
    id: "u2",
    sector: "RH",
    documentType: "Documento RH",
    fileName: "atestado-devair.pdf",
  ...
  },
  {
    ...
    fileName: "relatorio-escala-abr.xlsx",
...
export const moduleDefinitionsMock: ModuleDefinition[] = [
  {
    ...
    description:
      "Registro de abastecimento por veículo, com cupom fotografado e assinatura do motorista.",
    fields: [
